...
describe('ResultNormalizer', () => {
  ...
  describe('custom normalization rules', () => {
    it('should apply custom normalization rules', () => {
      ...
      const normalized = resultNormalizer.normalizeResult(toolResult as ToolResult);
  ...
  describe('validation and error handling', () => {
    it('should handle invalid tool results gracefully', () => {
      ...
      const normalized = resultNormalizer.normalizeResult(invalidResult as ToolResult);
