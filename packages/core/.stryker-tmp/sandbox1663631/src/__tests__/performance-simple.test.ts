...
import type { AnalysisPlugin } from '../plugins/analysis-plugin.js';
import type { Logger, AnalysisContext, ToolResult } from '../plugins/analysis-plugin.js';
...
describe('Performance Validation (PERF-001, PERF-002)', () => {
  ...
  describe('Performance Under Load', () => {
    it('should maintain performance with high plugin count', async () => {
      ...
      // Define the execution function outside the loop to avoid closure issues
      const executePlugin = async (plugin: AnalysisPlugin) => {
