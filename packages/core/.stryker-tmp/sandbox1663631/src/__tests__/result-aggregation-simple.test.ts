...
describe('Result Aggregation Validation (DATA-001)', () => {
  ...
  describe('Basic Result Aggregation', () => {
    ...
    it('should aggregate results with no issues', () => {
      const createMockResult = (toolName: string) => ({
        toolName,
        toolVersion: '1.0.0',
        status: 'success' as const,
        executionTime: 100,
  ...
  describe('Data Integrity Validation', () => {
    ...
    it('should handle error severity prioritization correctly', () => {
      const createMockResult = (toolName: string, hasErrors: boolean) => ({
        toolName,
        toolVersion: '1.0.0',
        status: 'success' as const,
        executionTime: 500,
  ...
  describe('Error Tolerance', () => {
    ...
    it('should handle aggregation with mixed quality results', () => {
      const createMockResult = (toolName: string, score: number, issuesCount: number) => ({
        toolName,
        toolVersion: '1.0.0',
        status: 'success' as const,
        executionTime: 500,
