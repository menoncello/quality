...
describe('DependencyChecker', () => {
    ...
    describe('detectDependencies', () => {
        it('should detect all dependency types', async () => {
            ...
            expect(dependencies.some(d => d.name === 'typescript' && d.type === 'devDependency')).toBe(true);
            expect(dependencies.some(d => d.name === 'react-redux' && d.type === 'peerDependency')).toBe(true);
            expect(dependencies.some(d => d.name === 'fsevents' && d.type === 'devDependency')).toBe(true); // optionalDependencies are treated as devDependency
        });
    ...
    function setupTestProject(dir, packageJson) {
        if (!existsSync(dir)) {
...
//# sourceMappingURL=dependency-checker.test.js.map