...
describe('Coverage Analysis Performance Benchmarks', () => {
    ...
    describe('concurrent performance', () => {
        it('should handle concurrent coverage analysis requests', async () => {
            ...
            const promises = Array.from({ length: concurrentRequests }, () => analyzer.analyzeCoverage(coverageData, mockContext));
    ...
    function generateMediumProjectCoverage() {
        const fileCount = 500;
        return generateProjectCoverage(fileCount);
    }
    function generateLargeProjectCoverage() {
        const fileCount = 1000;
        return generateProjectCoverage(fileCount);
    }
    function generateProjectCoverage(fileCount) {
        const files = [];
        let totalLines = 0;
...
//# sourceMappingURL=coverage-performance.test.js.map