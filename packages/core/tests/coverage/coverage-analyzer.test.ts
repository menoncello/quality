...
describe('CoverageAnalyzer', () => {
  ...
  let mockBasicCoverage: CoverageData;
  ...
  describe('configuration', () => {
    ...
    it('should respect exclusions', async () => {
      ...
      const result = await analyzerWithExclusions.analyzeCoverage(
        mockBasicCoverage,
        mockContext,
        mockDetailedCoverage
      );
  ...
  describe('edge cases', () => {
    it('should handle zero coverage', async () => {
      const zeroCoverage: CoverageData = {
  ...
  describe('recommendation engine', () => {
    it('should generate coverage improvement recommendations', async () => {
      const lowCoverage: CoverageData = {
    ...
    it('should generate appropriate recommendations based on coverage levels', async () => {
      const veryLowCoverage: CoverageData = {
        lines: { total: 100, covered: 30, percentage: 30 },
